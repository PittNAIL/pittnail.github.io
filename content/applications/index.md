...
function navigateLightbox(galleryId, direction) {
    ...
    ctr.textContent = (data.currentIndex + 1) + ' / ' + data.images.length;
}

document.addEventListener('keydown', function(e) {
    if (!window._activeLightboxId) return;
    if (e.key === 'Escape')      closeLightbox(window._activeLightboxId);
    if (e.key === 'ArrowLeft')   navigateLightbox(window._activeLightboxId, -1);
    if (e.key === 'ArrowRight')  navigateLightbox(window._activeLightboxId, 1);
});
</script>
...
{{ portfolio(
    ...
    developers="Yanshan Wang, PhD; Xizhi Wu, MS",
    PI="Yanshan Wang, PhD; University of Pittsburgh",
...
{{ portfolio(
    ...
    developers="Yanshan Wang, PhD; Yu-Chow Tam, MS; Sonish Sivarajkumar, MS",
    PI="Yanshan Wang, PhD; University of Pittsburgh",
...
{{ portfolio(
    ...
    PI="Yanshan Wang, PhD; Allyn Bove, DPT, PhD; University of Pittsburgh",
...
{{ portfolio(
    ...
    developers="Mariano De Leon, MS",
    PI="Yanshan Wang, PhD; Ding Dan, PhD; University of Pittsburgh",
    collaborators="Adit Shah; Gina Novario; University of Pittsburgh",
